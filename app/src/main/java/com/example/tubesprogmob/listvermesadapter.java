...
public class listvermesadapter extends RecyclerView.Adapter<listvermesadapter.ViewHolder>{
    private ArrayList<vermesmodel> dataKlmp;
    private Context context;
    listvermesadapter(ArrayList<vermesmodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<vermesmodel> filterModel) {
