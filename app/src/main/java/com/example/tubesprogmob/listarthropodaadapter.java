...
public class listarthropodaadapter extends RecyclerView.Adapter<listarthropodaadapter.ViewHolder>{
    private ArrayList<arthropodamodel> dataKlmp;
    private Context context;
    listarthropodaadapter(ArrayList<arthropodamodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<arthropodamodel> filterModel) {
