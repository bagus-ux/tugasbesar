...
public class listreptileadapter extends RecyclerView.Adapter<listreptileadapter.ViewHolder>{
    private ArrayList<reptilemodel> dataKlmp;
    private Context context;
    listreptileadapter(ArrayList<reptilemodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<reptilemodel> filterModel) {
