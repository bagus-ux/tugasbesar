...
public class listechinodermataadapter extends RecyclerView.Adapter<listechinodermataadapter.ViewHolder>{
    private ArrayList<echinodermatamodel> dataKlmp;
    private Context context;
    listechinodermataadapter(ArrayList<echinodermatamodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<echinodermatamodel> filterModel) {
