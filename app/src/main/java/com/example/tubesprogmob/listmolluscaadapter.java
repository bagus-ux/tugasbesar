...
public class listmolluscaadapter extends RecyclerView.Adapter<listmolluscaadapter.ViewHolder>{
    private ArrayList<molluscamodel> dataKlmp;
    private Context context;
    listmolluscaadapter(ArrayList<molluscamodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<molluscamodel> filterModel) {
