...
public class listamphibiadapter extends RecyclerView.Adapter<listamphibiadapter.ViewHolder>{
    private ArrayList<amphibimodel> dataKlmp;
    private Context context;
    listamphibiadapter(ArrayList<amphibimodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<amphibimodel> filterModel) {
