...
public class listmamaliaadapter extends RecyclerView.Adapter<listmamaliaadapter.ViewHolder>{
    private ArrayList<mamaliamodel> dataKlmp;
    private Context context;
    listmamaliaadapter(ArrayList<mamaliamodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<mamaliamodel> filterModel) {
