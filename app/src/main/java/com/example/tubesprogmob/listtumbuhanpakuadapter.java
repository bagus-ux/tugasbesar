...
public class listtumbuhanpakuadapter extends RecyclerView.Adapter<listtumbuhanpakuadapter.ViewHolder>{
    private ArrayList<tumbuhanpakumodel> dataKlmp;
    private Context context;
    listtumbuhanpakuadapter(ArrayList<tumbuhanpakumodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<tumbuhanpakumodel> filterModel) {
