...
public class listavesadapter extends RecyclerView.Adapter<listavesadapter.ViewHolder>{
    private ArrayList<avesmodel> dataKlmp;
    private Context context;
    listavesadapter(ArrayList<avesmodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<avesmodel> filterModel) {
