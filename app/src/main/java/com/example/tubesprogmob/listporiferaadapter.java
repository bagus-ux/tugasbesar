...
public class listporiferaadapter extends RecyclerView.Adapter<listporiferaadapter.ViewHolder>{
    private ArrayList<poriferamodel> dataKlmp;
    private Context context;
    listporiferaadapter(ArrayList<poriferamodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<poriferamodel> filterModel) {
