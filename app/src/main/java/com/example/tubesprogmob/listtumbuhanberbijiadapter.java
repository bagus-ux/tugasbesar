...
public class listtumbuhanberbijiadapter extends RecyclerView.Adapter<listtumbuhanberbijiadapter.ViewHolder>{
    private ArrayList<tumbuhanberbijimodel> dataKlmp;
    private Context context;
    listtumbuhanberbijiadapter(ArrayList<tumbuhanberbijimodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<tumbuhanberbijimodel> filterModel) {
