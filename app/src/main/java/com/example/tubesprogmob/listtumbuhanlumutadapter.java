...
public class listtumbuhanlumutadapter extends RecyclerView.Adapter<listtumbuhanlumutadapter.ViewHolder>{
    private ArrayList<tumbuhanlumutmodel> dataKlmp;
    private Context context;
    listtumbuhanlumutadapter(ArrayList<tumbuhanlumutmodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<tumbuhanlumutmodel> filterModel) {
