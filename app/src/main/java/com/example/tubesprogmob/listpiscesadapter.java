...
public class listpiscesadapter extends RecyclerView.Adapter<listpiscesadapter.ViewHolder>{
    private ArrayList<piscesmodel> dataKlmp;
    private Context context;
    listpiscesadapter(ArrayList<piscesmodel>dataKlmp, Context context ){
    ...
    void setFilter(ArrayList<piscesmodel> filterModel) {
